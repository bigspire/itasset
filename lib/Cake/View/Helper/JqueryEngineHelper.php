 ...
 */
	public function event($type, $callback, $options = array()) {
		...
		// modified by ravi on 7-7-2013
		if(($this->request->params['controller'] == 'search_jobs' && $this->request->params['action'] == 'index') || ($this->request->params['controller'] == 'search_resumes' && $this->request->params['action'] == 'index')){
