...
define('GS_PATH','c:\Program Files\Reader 9.0\Reader\AcroRd32.exe');

// Path to font metric files (AFM files). 
// NOTE: Trailing backslash required
define('TYPE1_FONTS_REPOSITORY', "c:\\Program Files\\Reader 9.0\\Resource\\font\\");
...
define('OUTPUT_FILE_DIRECTORY', 'uploads/payslip/');
