...
class EventsController extends FullCalendarAppController {
	...
	function feed($id=null) {
		...
		$conditions = array('conditions' => array('UNIX_TIMESTAMP(start) >=' => $vars['start'], 'UNIX_TIMESTAMP(start) <=' => $vars['end'], 'app_users_id'
	...
	function create() {
		$this->layout = "refresh";
		$vars = $this->params['url'];
		$data = array('title' => $vars['title'], 'start' => $vars['start'], 'end' => $vars['end'], 'created' => date('Y-m-d'), 'app_users_id' => 
