...
<?php if(!empty($this->params->query['theme'])):?>
<link rel="stylesheet" href="<?php echo $this->webroot;?>full_calendar/css/jquery-ui-1.10/css/<?php echo $this->params->query['theme'];?>/jquery-ui-1.10.4.custom.css">
<?php endif; ?>
