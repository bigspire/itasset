				...
				<?php echo $this->Session->flash();?>
					...
					<div class="span12">
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3><i class="icon-list"></i> Please fill the form to edit events</h3>
							</div>
							...
							<div class="span6">
									...
									<?php echo $this->Form->input('hr_branch_id', array( 'required' => false, 'legend' => false, 'before' => '','after' => '',    'between' => '  ',    'separator' => '  ','type' => 'select', 'label' => false, 'div' => false, 'class' => 'input-xlarge', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error', 'style' => 'clear:left')), 'options' => $branchList)); ?>
