				...
				<?php echo $this->Session->flash();?>
					...
					<div class="span12">
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3><i class="icon-user"></i> Add SPOC</h3>
							</div>
							<div class="box-content nopadding">
									<?php echo $this->Form->create('BdSpoc', array('id' => 'formID', 'class' => 'form-horizontal form-column form-bordered')); ?>
									...
									<div class="span12">
										<div class="form-actions">
											...
											<a href="<?php echo $this->webroot;?>bdspoc/"><button type="button" class="btn">Cancel</button></a>
										</div>
									</div>
