...
if(!empty($results)): 
	...
	foreach($results as $data):
		...
		$result[] = strtolower($this->Functions->match_results($keyword,$data['HrEmployee']['full_name']));		
		$result[] = strtolower($this->Functions->match_results($keyword,$data['HrDepartment']['dept_name']));
		$result[] = strtolower($this->Functions->match_results($keyword,$data['HrDesignation']['desig_name']));
