 <script type="text/javascript" src="https://www.google.com/jsapi"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
		...
		document.getElementById('att_png').outerHTML = '<a target="_blank" style="color:#fff" href="' + chart.getImageURI() + '">Print</a>';
      }
		...
		<div id="main"  class="" style="margin-left:200px">
			<div class="container-fluid">
				<div class="page-header">
					<div class="pull-left">
						<h1>Attendance Change Reports</h1>
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="<?php echo $this->webroot;?>hrreport/att_change/">Attendance Change Reports</a>
					...
					<div class="span12" >
						...
						<div class="box-title">
								<h3><i class="icon-bar-chart"></i> Attendance Change Reports </h3>
							</div>
							...
							<div id="att_div" style="width: 900px; height: 350px;"></div>
							 ...
							 <button  class="btn btn-primary"><i class="icon-print"></i>  <a id="att_png"></a></button>
