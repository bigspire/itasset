				...
				<?php echo $this->Session->flash();?>
					...
					<div class="span12">
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3><i class="icon-list"></i> Please fill the form to create a new gift details</h3>
							</div>
					...
					<?php echo $this->Form->input('member', array('div'=> false, 'id' => '', "data-placeholder" => "Select Members" , 'multiple' => 'multiple', 'type' => 'select', 'options' => $empList,  'label' => false, 'class' => 'chosen-select input-xlarge',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
