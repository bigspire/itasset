				...
				<?php echo $this->Session->flash();?>
					...
					<div class="span12">
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3><i class="icon-list"></i> Please fill the form to edit latest update</h3>
							</div>
								...
								<?php echo $this->Form->create('HrLatest', array('type' => 'file','id' => 'formID', 'class' => 'form-horizontal form-column form-bordered')); ?>
									...
									<div class="span12">
										...
										<div class="control-group">
											...
											<div class="control-group">
											<label for="textfield" class="control-label">Attachment <br><br><br></label>
											<div class="controls">
													...
													<br><?php if(!empty($this->request->data['HrLatest']['attachment'])) :?>
													<a href="<?php echo $this->webroot;?>hrlatest/download_update/<?php echo $this->request->data['HrLatest']['attachment'];?>/" class="btn btn-pink" rel="tooltip" title="Download"><?php echo $this->request->data['HrLatest']['attachment'];?></a>
													<?php endif; ?>
