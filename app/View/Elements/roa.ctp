...
<div id="roa_share_loading" class="dn">Loading data.. Pls wait..  <img src="<?php echo $this->webroot;?>img/loading.gif"></div><?php $i = 1;	
					...
					<div class="itemdiv dialogdiv line-<?php echo $this->Functions->get_line_color($i);?>" >															
							...
							<?php if($share['Share']['type'] == 'R' && $share['Share']['roa_type'] == 'S'):?>
		...
		<?php 
		if($share['Share']['type'] == 'R' && $share['Share']['roa_type'] == 'S'):
		$prev_id = '1';
		$info_type = 'company';
		$overlay_val = '50_57';
		else:
...
<?php echo ucwords($share['Home']['first_name'].' '.$share['Home']['last_name']);?></a> </p>
		<?php endif; ?>
					...
					<?php if($share['Share']['type'] == 'R' && $share['Share']['roa_type'] == 'S'): ?>
					<span>  <i style="color:" class="icon-thumbs-up-alt"></i> <a href="<?php echo $this->webroot;?>home/view_roa/<?php echo $share['Share']['roa_month'];?>/<?php echo $share['Share']['app_users_id'];?>/" class="iframeBox" val="60_60">Achievements</a> </span>										
					<?php endif; ?>	
				
					
		<?php
		if($share['Share']['roa_type'] == 'U'):		
		$folder = 'share';
		endif;
		...
		if(!empty($share['Share']['attachment'])):	
			...
			$height = $img_size[1];
				...
				<?php if($share['Share']['type'] == 'R'  && $share['Home']['photo_status'] == 'A'  && $share['Home']['photo'] != '' && $share['Share']['roa_type'] == 'S'):?>
