	...
	<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
													<?php echo $this->Form->input('att_type', array('div'=> false,'type' => 'select', 'selected' => $this->Session->read('personal.att_type'),'label' => false, 'class' => 'input-xlarge', 'empty' => 'Select', 'required' => false, 'placeholder' => '', 'style' => "clear:left", 'options' => $att_types, 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
											</div>
										</div>
			...
			<img class="dn" id="profilePic"/>
				...
				<span style="color:#ff0000" class="dn file_error"></span>	
										...
										<div class="control-group">
											...
											<div class="controls">
												<?php echo $this->Form->input('dob', array('div'=> false,'type' => 'text', 'label' => false, 'value' => $this->Session->read('personal.dob'),'class' => 'input-xlarge datepick',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> dd/mm/yyyy 
											</div>
										</div>
									...
									<div class="control-group">
											...
											<div class="controls">
												<?php echo $this->Form->input('doj', array('div'=> false,'type' => 'text', 'label' => false, 'class' => 'input-xlarge datepick',  'required' => false,'value' => $this->Session->read('personal.doj'), 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?>  dd/mm/yyyy 
											</div>
										</div>
...
<div class="control-group">
											...
											<div class="controls">
												<?php echo $this->Form->input('doc', array('div'=> false,'type' => 'text', 'label' => false, 'class' => 'input-xlarge datepick',  'required' => false,'value' => $this->Session->read('personal.doc'), 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?>  dd/mm/yyyy 
											</div>
										</div>
...
<div class="control-group">
											...
											<div class="controls">
												<?php echo $this->Form->input('probation', array('div'=> false,'type' => 'radio', 'label' => false, 'class' => 'input-xlarge',  'options' => array('Y' => 'Probation',  'C' => 'Confirmed'), 'value' => $this->Session->read('personal.probation'), 'separator' => ' ',  'required' => false, 'placeholder' => '', 'legend' => false, 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
											</div>
										</div>									
									...
									<div class="control-group">
											...
											<div class="controls">
												<?php echo $this->Form->input('app_roles_id', array('div'=> false,'type' => 'select', 'label' => false, 'class' => 'input-xlarge', 'empty' => 'Select', 'selected' => $this->Session->read('personal.app_roles_id'),'required' => false, 'placeholder' => '', 'style' => "clear:left", 'options' => $roleList, 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 	
											</div>
										</div>
											...
											<div class="controls">
												<?php echo $this->Form->input('hr_branch_id', array('div'=> false,'type' => 'select', 'label' => false, 'class' => 'input-xlarge', 'empty' => 'Select', 'selected' => $this->Session->read('personal.hr_branch_id'),'required' => false, 'placeholder' => '', 'style' => "clear:left", 'options' => $branchList, 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 	
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
													<?php echo $this->Form->input('skype', array('div'=> false,'type' => 'text', 'value' => $this->Session->read('personal.skype'), 'label' => false, 'class' => 'input-xlarge',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
											...
											<div class="controls">
													<?php echo $this->Form->input('pan', array('div'=> false,'type' => 'text', 'label' => false, 'value' => $this->Session->read('personal.pan'), 'class' => 'input-xlarge',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
											...
											<div class="controls">
													<?php echo $this->Form->input('insurance_no', array('div'=> false,'type' => 'text',  'value' => $this->Session->read('personal.insurance_no'),'label' => false, 'class' => 'input-xlarge',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
										...
										<div class="control-group">
											...
											<div class="controls">
													<?php echo $this->Form->input('pf_no', array('div'=> false,'type' => 'text', 'value' => $this->Session->read('personal.pf_no'),'label' => false, 'class' => 'input-xlarge',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
									...
									<div class="control-group">
											...
											<div class="controls">
													<?php echo $this->Form->input('esi_no', array('div'=> false,'type' => 'text', 'value' => $this->Session->read('personal.esi_no'),'label' => false, 'class' => 'input-xlarge',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
										...
										<div class="control-group">
											...
											<div class="controls">
													<?php echo $this->Form->input('emergency_contact_person', array('div'=> false,'type' => 'text','value' => $this->Session->read('personal.emergency_contact_person'), 'label' => false, 'class' => 'input-xlarge',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
										...
										<div class="control-group">
											...
											<div class="controls">
													<?php echo $this->Form->input('emergency_relation', array('div'=> false,'type' => 'text','value' => $this->Session->read('personal.emergency_relation'),  'label' => false, 'class' => 'input-xlarge',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
										...
										<div class="control-group">
											...
											<div class="controls">
													<?php echo $this->Form->input('emergency_contact_no', array('div'=> false,'type' => 'text','value' => $this->Session->read('personal.emergency_contact_no'),  'label' => false, 'class' => 'input-xlarge',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
								...
								<div class="control-group">
											...
											<div class="controls">
													<?php echo $this->Form->input('att_approve', array('div'=> false,'type' => 'select', 'selected' => $this->Session->read('personal.att_approve'),'label' => false, 'class' => 'input-xlarge', 'empty' => 'Select', 'required' => false, 'placeholder' => '', 'style' => "clear:left", 'options' => array('1' => 'Yes', '0' => 'No'), 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
											</div>
										</div>
								...
								<div class="control-group">
											...
											<div class="controls">
													<?php echo $this->Form->input('emp_type', array('div'=> false,'type' => 'select', 'selected' => $this->Session->read('personal.emp_type'),'label' => false, 'class' => 'input-xlarge empType', 'empty' => 'Select', 'default' => '1', 'required' => false, 'placeholder' => '', 'style' => "clear:left", 'options' => $emp_types, 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
											</div>
								</div>
									...
									<div class="control-group">
											...
											<div class="controls">
													<?php echo $this->Form->input('work_place', array('div'=> false,'type' => 'select', 'selected' => $this->Session->read('personal.work_place'),'label' => false, 'class' => 'input-xlarge', 'empty' => 'Select', 'default' => '1', 'required' => false, 'placeholder' => '', 'style' => "clear:left", 'options' => array('C' => 'Client Place', 'O' => 'Our Company'), 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
											</div>
										</div>	
											...
											<div class="controls">
													From <?php echo $this->Form->input('contract_from', array('div'=> false,'type' => 'text', 'value' => $this->Session->read('personal.contract_from'),'label' => false, 'class' => 'input-medium datepick','required' => false, 'placeholder' => '', 'style' => "clear:left", 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
													To <?php echo $this->Form->input('contract_to', array('div'=> false,'type' => 'text', 'value' => $this->Session->read('personal.contract_to'),'label' => false, 'class' => 'input-medium datepick',  'required' => false, 'placeholder' => '', 'style' => "clear:left", 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
				...
				<?php if($this->Functions->check_reg_confirm($this->Session->read('reg'))):?>
					 ...
					 <?php echo $this->Form->submit('Next & Confirm', array('div'=> false,  'label' => false, 'class' => 'btn btn-blue regconfirmBtn')); ?> 
					
					<?php //echo $this->Form->input('Next & Confirm', array('type' => 'submit', 'value' => 'Next & Confirm', 'label' => false, 'div' => false, 'class' => 'btn btn-blue')); ?>
