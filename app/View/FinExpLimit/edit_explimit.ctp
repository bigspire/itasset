				...
				<?php echo $this->Session->flash();?>
					...
					<div class="span12">
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3><i class="icon-list"></i> Please fill the form to edit expense limit</h3>
							</div>
							<div class="box-content nopadding">
								
								
								<?php echo $this->Form->create('FinExpLimit', array('id' => 'formID', 'class' => 'form-horizontal form-column form-bordered')); ?>
									...
									<div class="span6">
										...
										<div class="control-group">
											...
											<div class="controls">
													...
													<?php echo $this->Form->input('fin_exp_category_id', array('div'=> false,'type' => 'select', 'label' => false, 'class' => 'input-xlarge', 'empty' => 'Select', 'required' => false, 'placeholder' => '', 'style' => "clear:left", 'options' => $catList, 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
											...
											<div class="controls">
													...
													<?php echo $this->Form->input('amount', array('div'=> false,'type' => 'text', 'label' => false, 'class' => 'input-xlarge',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
											</div>
										</div>
...
<div class="span6">									
									...
									<div class="span12">
										<div class="form-actions">
											...
											<a href="<?php echo $this->webroot;?>finexplimit/"><button type="button" class="btn">Cancel</button></a>
										</div>
									</div>
									<?php echo $this->Form->input('id', array('type' => 'hidden'));?>
										<?php echo $this->Form->input('page', array('value' => 'edit', 'type' => 'hidden'));?>
