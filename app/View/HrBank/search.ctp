...
if(!empty($results)): 
	...
	foreach($results as $data):
		...
		$result[] = strtolower($this->Functions->match_results($keyword,$data['HrBank']['bank']));
		$result[] = strtolower($this->Functions->match_results($keyword,$data['HrBank']['branch']));	
		$result[] = strtolower($this->Functions->match_results($keyword,$data['HrBank']['ifsc']));			
