    ...
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="490" valign="top"  style="padding:0 20px;"><h1 style="font:bold 15px Arial, Helvetica, sans-serif; color:#676767; margin:0 0 10px 0;">Dear <?php echo ucwords($name); ?>,</h1>
          <p style="font:13px Arial, Helvetica, sans-serif; color:#676767; margin:0;"><?php echo $employee;?> contract period is about to complete. Please take necessary action.</p><br />

          <p style="font:bold 13px Arial, Helvetica, sans-serif; color:#676767; margin:0;">Below are the employee contract details,</p>
          <table width="100%" border="0" cellspacing="2" cellpadding="10" style="border:1px solid #ededed; font:bold 13px Arial, Helvetica, sans-serif; color:#6f6e6e; margin:10px 0 20px 0;">
             ...
             <tr style="background:#f5f4f4;">
              ...
              <td style="color:#2a2a2a;"><?php echo $type == 'A' ? 'Associate 1' : 'Associate 2';?></td>         
            </tr>
           
		    <tr style="background:#f5f4f4;">
			  <td width="">Contract From</td>
              <td style="color:#2a2a2a;"><?php echo $this->Functions->format_date($cf);?></td>
                <td width="100">Contract To</td>
              <td style="color:#2a2a2a;"><?php echo $this->Functions->format_date($ct);?></td>           
            </tr>
