    ...
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="490" valign="top"  style="padding:0 20px;"><h1 style="font:bold 15px Arial, Helvetica, sans-serif; color:#676767; margin:0 0 10px 0;">Dear <?php echo ucwords($name); ?>,</h1>
          <p style="font:13px Arial, Helvetica, sans-serif; color:#676767; margin:0;">Permission request is <?php echo $status;?> by <?php echo ucfirst($this->Session->read('USER.Login.first_name')).' '.ucfirst($this->Session->read('USER.Login.last_name')); ?>. Please login to My PDCA and check the status of the request.</p><br />

          <p style="font:bold 13px Arial, Helvetica, sans-serif; color:#676767; margin:0;">Below are the permission request details,</p>
          <table width="100%" border="0" cellspacing="2" cellpadding="10" style="border:1px solid #ededed; font:bold 13px Arial, Helvetica, sans-serif; color:#6f6e6e; margin:10px 0 20px 0;">
             ...
             <tr style="background:#f5f4f4;">
              ...
              <td style="color:#2a2a2a;"><?php echo $this->Functions->format_date($per_date);?></td>            
            </tr>
			  <tr style="background:#f5f4f4;">
              <td>From Time</td>
              <td style="color:#2a2a2a;"><?php echo $this->Functions->format_time_show($per_from);?></td>
              <td>To Time</td>
              <td style="color:#2a2a2a;"><?php echo $this->Functions->format_time_show($per_to);?></td>
            </tr>
            <tr style="background:#f5f4f4;">
              <td>Total Hrs.</td>
              <td style="color:#2a2a2a;"><?php echo $this->Functions->display_hrs($nohrs);?></td>
			  <td>&nbsp;</td>
			...
			<?php if(strtotime($per_date) < strtotime(date('Y-m-d'))):?>
			 <tr style="background:#f5f4f4;">
              <td colspan="2">Did you inform about the permission already?</td>
