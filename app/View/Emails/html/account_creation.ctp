...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="border:2px solid #fff; background:#fff; margin-bottom:40px">
    ...
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="490" valign="top"  style="padding:0 20px;"><h1 style="font:bold 15px Arial, Helvetica, sans-serif; color:#676767; margin:0 0 10px 0;">Dear <b><?php echo ucwords($name); ?>,</h1>
          <p style="font:13px Arial, Helvetica, sans-serif; color:#676767; margin:0;">Welcome to My PDCA</p><br />

          <p style="font:normal 13px Arial, Helvetica, sans-serif; color:#676767; margin:0;">Your account has been created successfully in My PDCA</p>
          <table width="100%" border="0" cellspacing="2" cellpadding="10" style="border:1px solid #ededed; font:bold 13px Arial, Helvetica, sans-serif; color:#6f6e6e; margin:10px 0 20px 0;">
              ...
              <td>Website</td>
              <td   colspan="3" style="color:#2a2a2a;"><a href="<?php echo Configure::read('WEBSITE');?>" title="link" style="color:#1c99fa;"><?php echo Configure::read('WEB'); ?></a></td>
			  ...
			  <tr style="background:#f5f4f4;">
              <td>Email Address</td>
              <td   colspan="3" style="color:#2a2a2a;"><?php echo $email; ?></td>
            
            </tr>
			
			  <tr style="background:#f5f4f4;">
              <td>Password</td>
              <td   colspan="3" style="color:#2a2a2a;">Your Email Password</td>
  ...
  <tr>
    <td colspan="2"> <p style="font:bold 13px Arial, Helvetica, sans-serif; color:#676767;margin-left:10px;">Thanks, Team - My PDCA</p></td>
  </tr>
