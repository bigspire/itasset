    ...
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="490" valign="top"  style="padding:0 20px;"><h1 style="font:bold 15px Arial, Helvetica, sans-serif; color:#676767; margin:0 0 10px 0;">Dear <?php echo ucwords($name); ?>,</h1>
          <p style="font:13px Arial, Helvetica, sans-serif; color:#676767; margin:0;">Your PL request is <?php echo $status;?> by <?php echo ucfirst($this->Session->read('USER.Login.first_name')).' '.ucfirst($this->Session->read('USER.Login.last_name')); ?>. 
		  <?php if($status == 'approved'):?>
		  Please login to My PDCA and create PL request for the approved days.
		  <?php endif; ?>
		  </p><br />

          <p style="font:bold 13px Arial, Helvetica, sans-serif; color:#676767; margin:0;">Below are the PL request details,</p>
          <table width="100%" border="0" cellspacing="2" cellpadding="10" style="border:1px solid #ededed; font:bold 13px Arial, Helvetica, sans-serif; color:#6f6e6e; margin:10px 0 20px 0;">
            ...
            <tr style="background:#f5f4f4;">              
			  ...
			  <td>No. of Days</td>
              <td style="color:#2a2a2a;"><?php echo $no_days;?> Days</td>
            </tr>
...
email us.  <a href="mailto:philip@career-tree.in" style="color:#e56712;">philip@career-tree.in </a> 
</p>
    </td>
  </tr>
</table>
