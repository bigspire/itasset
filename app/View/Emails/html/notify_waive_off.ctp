    ...
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="490" valign="top"  style="padding:0 20px;"><h1 style="font:bold 15px Arial, Helvetica, sans-serif; color:#676767; margin:0 0 10px 0;">Dear <?php echo ucwords($name); ?>,</h1>
          <p style="font:13px Arial, Helvetica, sans-serif; color:#676767; margin:0;"><?php echo $employee;?> late minutes waived off by <?php echo $this->Session->read('USER.Login.first_name')?> 
		   <?php echo $this->Session->read('USER.Login.last_name')?>.</p><br />

          <p style="font:bold 13px Arial, Helvetica, sans-serif; color:#676767; margin:0;">Below are the waive off details,</p>
          <table width="100%" border="0" cellspacing="2" cellpadding="10" style="border:1px solid #ededed; font:bold 13px Arial, Helvetica, sans-serif; color:#6f6e6e; margin:10px 0 20px 0;">
             ...
             <tr style="background:#f5f4f4;">
              ...
              <td style="color:#2a2a2a;"><?php echo $employee;?></td>
               <td width="150">Minutes waived off</td>
              <td style="color:#2a2a2a;"><?php echo $minute;?></td>         
            </tr>
           
		 <tr style="background:#f5f4f4;">			  
              <td width="">Total Late Mins. after waived off</td>
              <td style="color:#2a2a2a;"><?php echo $tot_late - $minute;?></td>  
			  <td width="">&nbsp;</td>
