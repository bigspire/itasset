    ...
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="490" valign="top"  style="padding:0 20px;"><h1 style="font:bold 15px Arial, Helvetica, sans-serif; color:#676767; margin:0 0 10px 0;">Dear <?php echo ucwords($name); ?>,</h1>
          <p style="font:13px Arial, Helvetica, sans-serif; color:#676767; margin:0;">Payment is updated for your expense submission by <?php echo ucfirst($this->Session->read('USER.Login.first_name')).' '.ucfirst($this->Session->read('USER.Login.last_name')); ?></p><br />

          <p style="font:bold 13px Arial, Helvetica, sans-serif; color:#676767; margin:0;">Below are the payment details,</p>
          <table width="100%" border="0" cellspacing="2" cellpadding="10" style="border:1px solid #ededed; font:bold 13px Arial, Helvetica, sans-serif; color:#6f6e6e; margin:10px 0 20px 0;">
            ...
            <tr style="background:#f5f4f4;">			 
              ...
              <td style="color:#2a2a2a;"><?php echo $this->Functions->format_date($date);?></td> 			  
            </tr>
           
            <tr style="background:#f5f4f4;">
              <td>Paid to Employee</td>
              <td style="color:#2a2a2a;">Rs. <?php echo $paid_emp;?></td>			  
             <td>Payment Date</td>
             ...
             <td>Total Balance Advance in Hand</td>
			...
			<tr style="background:#f5f4f4;">
             <td>Received from Employee</td>
              <td style="color:#2a2a2a;">
			  
			  <?php if($receive_emp > 0):?>
			  Rs. <?php echo $receive_emp;
			  else:
			  echo '--';
			  endif; ?>
