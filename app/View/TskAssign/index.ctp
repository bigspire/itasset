			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="<?php echo $this->webroot;?>tskassign/">Assigned to Me</a>
							<i class="icon-angle-right"></i>
						</li>
				...
				<?php echo $this->Session->flash();?>
					...
					<div class="span12">
						...
						<?php echo $this->Form->create('TskAssign', array('name' => '', 'type' => '', 'id' => 'formID', 'class' => '')); ?>
							<div class="">
				...
				<a href="<?php echo $this->webroot;?>tskassign/"><button style="margin-bottom:9px;margin-left:4px;" type="button" class="btn btn-primary"><i class="icon-refresh"></i> Reset</button></a>
			...
			<ul class="nav nav-pills" style="">
						...
						<li class="dropdown active">
							...
							<ul class="dropdown-menu" style="min-width:100px">												
								...
								<li><a href="<?php echo $this->webroot;?>tskassign/?type=P">Project Task</a></li>
								<?php else: ?>
								<li><a href="<?php echo $this->webroot;?>tskassign/?type=D">Daily Task</a></li>
								<?php endif; ?>
				...
				<div  width="85%" id="eventCalendarDefault" style="clear:both;"></div>
							...
							<input type="hidden" value="1" id="tskassign">
					<input type="hidden" value="<?php echo $this->webroot;?>" id="webroot">

					
					<input type="hidden" class="srch_tsk_type" name="data[TskAssign][type]" value="<?php echo $this->request->query['type'] ? $this->request->query['type'] :'D';?>" id="type">
						...
						<input type="hidden" value="<?php echo $this->webroot;?>tskassign/" id="root">
						<input type="hidden" value="<?php echo $this->webroot;?>" id="calroot">
										 <input type="hidden" id="pageCache" value="1">
							<input type="hidden" value="<?php echo $this->request->query['type'] ? $this->request->query['type'] : 'D';?>" id="tskplan_type" >
