		...
		<div id="main">
			<div class="container-fluid">
					...
					<div class="span12">
						<div class="box box-color">
							...
							<div class="box-content nopadding">
								...
								<?php echo $this->Form->create('TvlReqApr', array('id' => 'formID', 'class' => 'form-horizontal form-column form-bordered')); ?>
								...
								<div class="row-fluid row1" style="margin-top:10px;border:1px solid #efefef">
									...
									<?php echo $this->Functions->get_tvl_id($this->request->params['pass'][0]);?>			
										...
										<div class="control-group">
											...
											<div class="controls">
									<?php echo $this->Functions->get_travel_type($tvl_data['TvlReqApr']['type']);?>			
				...
				<?php echo $tvl_data['TvlDebit']['company_name'];?>									
											...
											<div class="controls">
											<?php echo $tvl_data['TvlReqApr']['purpose'];?>										
								...
								<div class="control-group">
										...
										<?php	if($tvl_data['TvlReqApr']['type'] == 2):		?>
										<div class="control-group">
					...
					<?php echo $tvl_data['TvlStart']['place'];?> to <?php echo $tvl_data['TvlPlace']['place'];?>											</div>
										...
										<div class="control-group">
											...
											<?php echo $this->Functions->format_date_show($tvl_data['TvlReqApr']['start_date']);?>
					<?php if($tvl_data['TvlReqApr']['type'] == 2):?>,  
					<?php echo $this->Functions->format_date_show($tvl_data['TvlReqApr']['return_date']);?> (Return)
					<?php endif; ?>
								 ...
								 <?php if($tvl_data['TvlReqApr']['type'] == 2):
									...
									?>
											...
											<div class="controls">
		<?php if($tvl_data['TvlReqApr']['desire_depart_from'] && 	$tvl_data['TvlReqApr']['desire_depart_to']):?>						
				Departure: <?php echo $this->Functions->format_time_show($tvl_data['TvlReqApr']['desire_depart_from']);?> to <?php echo $this->Functions->format_time_show($tvl_data['TvlReqApr']['desire_depart_to']);?>; 
				<?php endif; ?>
				<?php if($tvl_data['TvlReqApr']['desire_arrival_from'] && 	$tvl_data['TvlReqApr']['desire_arrival_to']):?>	
				Arrival: <?php echo $this->Functions->format_time_show($tvl_data['TvlReqApr']['desire_arrival_from']);?> to <?php echo $this->Functions->format_time_show($tvl_data['TvlReqApr']['desire_arrival_to']);?>
				<?php endif; ?>										
															</div>
										</div>
								...
								<?php if($tvl_data['TvlReqApr']['type'] == 2):?>		
									<div class="control-group">
											...
											<div class="controls">
			<?php if($tvl_data['TvlReqApr']['desire_return_depart_from'] && 	$tvl_data['TvlReqApr']['desire_return_depart_to']):?>						
				Departure: <?php echo $this->Functions->format_time_show($tvl_data['TvlReqApr']['desire_return_depart_from']);?> to <?php echo $this->Functions->format_time_show($tvl_data['TvlReqApr']['desire_return_depart_to']);?>; 
				<?php endif; ?>
				<?php if($tvl_data['TvlReqApr']['desire_return_arrival_from'] && 	$tvl_data['TvlReqApr']['desire_return_arrival_to']):?>	
				Arrival: <?php echo $this->Functions->format_time_show($tvl_data['TvlReqApr']['desire_return_arrival_from']);?> to <?php echo $this->Functions->format_time_show($tvl_data['TvlReqApr']['desire_return_arrival_to']);?>
				<?php endif; ?>								
															</div>
										</div>
									<?php endif; ?>					
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<?php echo $tvl_data['TvlReqApr']['spl_particular']; ?>
											...
											<div class="controls">
								<?php echo $tvl_data['TvlReqApr']['expected_outcome']; ?>							
							...
							<?php endforeach; ?>		
									...
									<div class="span12">
										<div class="form-actions">
											...
											<?php if($VIEW_ONLY == 1):?>
												<a href="<?php echo $this->webroot;?>tvlreqapr/"><button type="button" class="btn"><< Go Back</button></a>
										<?php else: ?>
										<a class="" href="javascript:void(0);">
											<button type="button" name="<?php echo $this->webroot;?>tvlreqapr/process_req/<?php echo $this->request->params['pass'][0];?>/<?php echo $this->request->params['pass'][1];?>/A/<?php echo $this->request->params['pass'][2];?>/" class="btn btn-green approveRec">Approve</button></a>
											
											
											<a href="javascript:void(0);">
											<button type="button" name="<?php echo $this->webroot;?>tvlreqapr/process_req/<?php echo $this->request->params['pass'][0];?>/<?php echo $this->request->params['pass'][1];?>/R/<?php echo $this->request->params['pass'][2];?>/" class="btn btn-red rejectRec">Reject</button></a>
											
											<a href="<?php echo $this->webroot;?>tvlreqapr/"><button type="button" class="btn">Cancel</button></a>
