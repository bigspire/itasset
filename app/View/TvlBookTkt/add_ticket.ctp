...
.ui-widget-header{color:#000000}
	...
	<div class="container-fluid" id="content">
							...
							<div class="box-content nopadding">
								...
								<?php echo $this->Form->create('TvlTicket', array('type' => 'file', 'id' => 'formID', 'class' => 'form-horizontal form-column form-bordered')); ?>
									...
									<div class="span6">
											...
											<label for="textfield" class="control-label">Ticket <span class="red_star">*</span></label>
											<div class="controls">
											
				<?php echo $this->Form->input('tkt1', array('div'=> false, 'id' => 'ticket','type' => 'file', 'label' => false, 'class' => 'input-block-level',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												<div class="error ticket"></div>
												</div>
										</div>
		...
		<?php echo $this->Form->input('book_ref_no', array('div'=> false, 'id' => 'ref_no','type' => 'text', 'label' => false, 'class' => 'input-medium',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
						...
						<input type="submit" value="Send" class="send_ticket btn btn-primary">
						
									<input type="button" value="Cancel" class="can_btn close_colorBox btn">		
						</div>
							</div>
