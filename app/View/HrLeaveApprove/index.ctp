			...
			<div class="container-fluid">
				...
				<?php echo $this->Session->flash();?>
					...
					<div class="span12">
						...
						<div class="box-title">
								<h3><i class="icon-list"></i> Approve Leave</h3>
							</div>
							
						

						<?php echo $this->Form->create('HrLeaveApprove', array('name' => '', 'type' => '', 'id' => 'formID', 'class' => '')); ?>
...
<span>Leave To:</span>  
				...
				<a href="<?php echo $this->webroot;?>hrleaveapprove/"><button style="margin-bottom:9px;margin-left:4px;" type="button" class="btn btn-primary"><i class="icon-refresh"></i> Reset</button></a>
	...
	<table class="table table-hover table-nomargin table-bordered usertable dataTable">
							...
							<th width="110">
											...
											<th width="300"><?php echo $this->Paginator->sort('reason', 'Reason', array('escape' => false,'direction' => 'desc'));?></th>
											<th width="110">	
									...
									<tbody>
										...
										<tr>
											...
											<td><?php echo $this->Functions->format_date($leave['HrLeaveApprove']['leave_from']);?></td>
													
											<td><?php echo $this->Functions->format_date($leave['HrLeaveApprove']['leave_to']);?></td>
											<td><?php echo $leave['HrLeaveApprove']['no_days'];?></td>
												<td><?php echo $leave['HrLeaveType']['desc'];?></td>
												<td><?php echo  $this->Functions->string_truncate($leave['HrLeaveApprove']['reason'], 30);?></td>
											<td><?php echo $this->Functions->format_date($leave['HrLeaveApprove']['created_date']);?></td>
											
											<td><?php 
											//print_r($leave['HrLeaveApprove']['status_order']);
											$pending = strstr($leave[0]['st_status'], 'W');
											if(!empty($pending)):
											echo $this->Functions->time_diff($leave['HrLeaveApprove']['created_date'], 0);endif;
											?>
											...
											<td>											
												...
												<a href="<?php echo $this->webroot;?>hrleaveapprove/view_leave/<?php echo $leave['HrLeaveApprove']['id'];?>/<?php echo $leave[0]['status_id'];?>/<?php echo $leave['Home2']['id'];?>" class="btn" rel="tooltip" title="<?php echo $title;?>"><i class="<?php echo $icon;?>"></i></a>
