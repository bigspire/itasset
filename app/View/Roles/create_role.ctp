...
<div class="span6">									
											...
											<div class="controls">
													...
													<?php echo $this->Form->input('permission', array('multiple' => 'multiple', 'size' => '10', 'required' => false, 'legend' => false, 'before' => '','after' => '',    'between' => '  ',    'separator' => '  ','type' => 'select', 'label' => false, 'div' => false, 'class' => 'input-xlarge', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error', 'style' => 'clear:left')), 'options' => $moduleList, 'class' => 'multi_select')); ?>
											</div>
										</div>
