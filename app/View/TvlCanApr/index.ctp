			...
			<div class="container-fluid">
				...
				<?php echo $this->Session->flash();?>
					...
					<div class="span12">
						...
						<?php echo $this->Form->create('TvlCanApr', array('name' => '', 'type' => '', 'id' => 'formID', 'class' => '')); ?>
				...
				<span>Employee:</span>		<?php echo $this->Form->input('emp_id', array('div'=> false,'type' => 'select', 'label' => false, 'class' => 'input-large', 'empty' => 'Select', 'selected' => $this->params->query['emp_id'], 'required' => false, 'placeholder' => '', 'style' => "clear:left", 'options' => $empList, 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
								...
								<a href="<?php echo $this->webroot;?>tvlcanapr/"><button style="margin-bottom:9px;margin-left:4px;" type="button" class="btn btn-primary"><i class="icon-refresh"></i> Reset</button></a>
...
<input type="hidden" id="del_url" value="<?php echo $this->webroot;?>tvlcanapr/delete_tvlance/"/>
						...
						<?php echo $this->Paginator->sort('first_name', 'Employee', array('escape' => false,'direction' => 'desc'));?>
							...
							<td><?php echo ucfirst($tvl['Home2']['first_name']).' '.ucfirst($tvl['Home2']['last_name']);?></td>
											...
											<td><?php echo $this->Functions->format_date($tvl['TvlCanApr']['start_date']);?></td>
											<td><?php echo $tvl['TvlCanApr']['tvl_code'];?></td>
											<td><?php echo $this->Functions->get_travel_type($tvl['TvlCanApr']['type']);?></td>
									...
									<td class='hidden-350'><?php $pending = strstr($tvl[0]['st_status'], 'W');
											if(!empty($pending)):
											echo $this->Functions->time_diff($tvl['TvlCanApr']['created_date'], 0);
											 endif; ?></td>
								<td class='hidden-350'>
					...
					<a href="<?php echo $this->webroot;?>tvlcanapr/view_request/<?php echo $tvl['TvlCanApr']['id'];?>/<?php echo $tvl[0]['status_id'];?>/<?php echo $tvl['Home2']['id'];?>" class="btn" rel="tooltip" title="<?php echo $title;?>"><i class="<?php echo $icon;?>"></i></a>
						...
						<input type="hidden" value="<?php echo $this->webroot;?>tvlcanapr/" id="webroot">
