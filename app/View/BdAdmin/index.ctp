		...
		<div id="main">
			<div class="container-fluid">
				...
				<?php echo $this->Session->flash();?>
					...
					<div class="span12">
						...
						<div class="box-title">
								<h3><i class="icon-list"></i> BD Admin</h3>
							</div>
							
						

						<?php echo $this->Form->create('BdAdmin', array('name' => '', 'type' => '', 'id' => 'formID', 'class' => '')); ?>
			...
			<?php echo $this->Form->input('keyword', array('div'=> false,'type' => 'text', 'id' => 'SearchText', 'label' => false, 'class' => 'input-xlarge ', 'value' => $this->params->query['keyword'], 'required' => false, 'autocomplete' => 'off', 'placeholder' => 'Search here...', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
											...
											<input type="submit" value="Search" class="btn btn-primary" style="margin-bottom:9px;margin-left:4px;">
													...
													<a href="<?php echo $this->webroot;?>bdadmin/"><button style="margin-bottom:9px;margin-left:4px;" type="button" class="btn btn-primary"><i class="icon-refresh"></i> Reset</button></a>
											
						<a href="<?php echo $this->webroot;?>bdadmin/add_admin/"><button type="button" class="btn btn-primary" style="float:right"><i class="icon-plus"></i> Add BD Admin</button></a>
								</div>			
...
<input type="hidden" id="del_url" value="<?php echo $this->webroot;?>bdadmin/delete_spoc/"/>
								...
								<table class="table table-hover table-nomargin table-bordered usertable dataTable">
									...
									<tbody>
										...
										<tr>
											...
											<td><?php echo $this->Functions->format_date($spoc['BdAdmin']['created_date']);?></td>
										
											
											<td>								
		<?php echo $this->Functions->show_status($spoc['BdAdmin']['status']);?>
</td>
											<td class='hidden-480'>
			<a href="javascript:void(0);" name="<?php echo $spoc['BdAdmin']['id'];?>" class="btn delRec" rel="tooltip" title="Delete"><i class="icon-remove"></i></a>
