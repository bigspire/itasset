		...
		<div id="main">
			<div class="container-fluid">
				<div class="page-header">
					<div class="pull-left">
						<h1>Edit <?php echo $APPROVER_TYPE;?></h1>
					</div>
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="#">Edit <?php echo $APPROVER_TYPE;?></a>
						</li>
					</ul>
					...
					<div class="span12">
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3><i class="icon-list"></i> Please fill the form to edit <?php echo $APPROVER_TYPE;?></h3>
							</div>
								...
								<?php echo $this->Form->create('Approve', array('id' => 'formID', 'class' => 'form-horizontal form-column form-bordered')); ?>
									...
									<div class="span12">
										<div class="control-group">
											...
											<div class="controls">
													<?php echo $this->Form->input('app_users_id', array('div'=> false,'type' => 'select', 'label' => false, 'class' => 'input-large', 'empty' => 'Select', 'required' => false, 'placeholder' => '', 'options' => $empList, 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?>
