...
if(!empty($results)): 
	...
	foreach($results as $data):
			...
			$result[] = strtolower($this->Functions->match_results($keyword,$data['FinExpenses']['expense_no']));
			$result[] = strtolower($this->Functions->match_results($keyword,$data['Project']['project_name']));
			$result[] = strtolower($this->Functions->match_results($keyword,$data['Customer']['company_name']));
