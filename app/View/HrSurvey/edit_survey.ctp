		...
		<div id="main">
			<div class="container-fluid">
				...
				<?php echo $this->Session->flash();?>
					...
					<div class="span12">
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3><i class="icon-list"></i> Please fill the form to edit survey</h3>
							</div>
							<div class="box-content nopadding">
								...
								<?php $total = count($survey_question);
								foreach($survey_question as $key => $qn):?>
								<div class="control-group">
											<label for="textfield" class="control-label">Question <?php echo ++$key; ?> 
											<?php if($key < 5):?><span class="red_star">*</span><?php endif; ?>
											</label>
											<div class="controls">
										
													<?php echo $this->Form->input('qn'.$key, array('div'=> false,'value' => $qn['HrSurveyQuestion']['question'], 'type' => 'text', 'label' => false, 'class' => 'input-xxlarge',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
											</div>
										</div>
				...
				if($total < 11):
					for($j = ++$total; $j <= 10; $j++):?>
								<div class="control-group">
											<label for="textfield" class="control-label">Question <?php echo $j; ?> 
											<?php if($j < 5):?><span class="red_star">*</span><?php endif; ?>
											</label>
											<div class="controls">
										
													<?php echo $this->Form->input('qn'.$j, array('div'=> false, 'type' => 'text', 'label' => false, 'class' => 'input-xxlarge',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
											</div>
										</div>
