			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="<?php echo $this->webroot;?>tskplantype/">Task Plan Types</a>
								<i class="icon-angle-right"></i>
						</li>
						
						<li>
							<a href="#">Create Task Type</a>
						</li>
					</ul>
				...
				<?php echo $this->Session->flash();?>
					...
					<div class="span12">
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3><i class="icon-list"></i> Please fill the form to create task plan type</h3>
							</div>
							<div class="box-content nopadding">
								
								
								<?php echo $this->Form->create('TskPlanType', array('id' => 'formID', 'class' => 'form-horizontal form-column form-bordered')); ?>
...
<div class="span6">									
										...
										<div class="control-group">
											...
											<div class="controls">
													...
													'placeholder' => '', 'style' => "clear:left", 'options' => array('1' => 'Active', '0' => 'Inactive'), 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
											</div>
										</div>
									...
									<div class="span12">
										<div class="form-actions">
											...
											<a href="<?php echo $this->webroot;?>tskplantype/"><button type="button" class="btn">Cancel</button></a>
										</div>
									</div>
