...
class TskRoa extends AppModel {
	...
	*/
	...
	public function check_employee(){ 
		if(empty($this->data['TskRoa']['type']) && empty($this->data['TskRoa']['employee1'])){
			return false;
		}else if($this->data['TskRoa']['type'] == 'I' && empty($this->data['TskRoa']['employee1'])){
			return false;
		}else if($this->data['TskRoa']['type'] == 'T' && empty($this->data['TskRoa']['employee2'])){
			return false;
		}
		return true;
	}
	...
	public function check_rating(){
		if(empty($this->data['TskRoa']['rating']) || $this->data['TskRoa']['rating'] == 1){
			return false;
		}else{
			return true;
		}
	...
	public function validate_applause_cat(){ 
		if(!empty($this->data['TskRoa']['applause_cat'])){
			return true;
		}else{
			return false;
		}
	...
	public function validate_file(){ 	
		if(!empty($this->data['TskRoa']['upload_file']['name'])){ 
