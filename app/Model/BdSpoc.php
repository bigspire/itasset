...
class BdSpoc extends AppModel {
	
	public $name = 'BdSpoc';
	 
	public $useTable = 'bd_spoc';
	...
	public function validate_exist(){
		$count = $this->find('count', array('conditions' => array('BdSpoc.is_deleted' => 'N', 'app_users_id' => $this->data['BdSpoc']['app_users_id'])));
		if($count){
			return false;
		}else{
			return true;
