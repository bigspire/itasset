...
function content_5ae2c66bcfe969_39244369 ($_smarty_tpl) {
...
><?php echo $_smarty_tpl->tpl_vars['item']->value['status'];?>
									 ...
									 </a></span><br><span style="color:#ff0000;font-size:11px;"><?php if ($_smarty_tpl->tpl_vars['item']->value['scrap_status'] != 'R') {
echo $_smarty_tpl->tpl_vars['item']->value['scrap_hw_type'];
}?></span></td>
									 <td class='hidden-480'>
...
" class="btn" rel="tooltip" title="View"><i class="icon-search"></i></a>
											...
											<?php if ($_smarty_tpl->tpl_vars['item']->value['scrap_id'] == '' || ($_smarty_tpl->tpl_vars['item']->value['scrap_id'] != '' && $_smarty_tpl->tpl_vars['item']->value['scrap_status'] == 'R')) {?>
