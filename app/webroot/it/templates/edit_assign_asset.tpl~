...
<div class="span6">	
	...
	<div class="control-group" id="swDiv1_#index#">
		<label for="textfield" class="control-label">Software Type <span class="red_star"> *</span></label>
				<div class="controls field">
					<select name="sw_type_id_#index#" class="input-xlarge" placeholder="" style="clear:left"  id="sw_type_id_#index#">
	...
	<div class="control-group dn" id="hwDiv1_#index#">
		<label for="textfield" class="control-label">Hardware Type <span class="red_star"> *</span></label>
		 <div class="controls field">
			<select name="hw_type_id_#index#" class="input-xlarge" placeholder="" style="clear:left"  id="hw_type_id_#index#">
				<option value="">Select</option>	
...
<div class="span6" style="border-bottom:1px solid #ddd;">		
	...
	<div class="control-group" id="swDiv2_#index#">
		<label for="password" class="control-label">Edition <span class="red_star"> *</span></label>
			<div class="controls">
				<select name="edition_it_id_#index#" class="input-xlarge checkUnique_edition" placeholder="" style="clear:left"  id="edition_it_id_#index#" >
					<option value="">Select</option>					
	...
	<div class="control-group dn" id="hwDiv2_#index#">
		<label for="password" class="control-label">Inventory No 
			<span class="red_star"> *</span></label>
				<div class="controls">
					<select placeholder="" style="clear:left"  name="inventory_it_id_#index#" class="input-xlarge checkUnique" id="inventory_it_id_#index#">
						<option value="">Select</option>
							{html_options options=$h_inventory selected=$inventory_it_id} 
					</select>
...
{for $i=0; $i < $totCount; $i++}
		...
		<input type="hidden" id="it_hw_brand_idData_{$i}" name="it_hw_brand_idData_{$i}" value="{$it_hw_brand_idData[$i]}">
