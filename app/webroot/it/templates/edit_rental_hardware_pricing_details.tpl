			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					...
					<div class="span12">
								...
								<form action="edit_rental_hardware_pricing_details.php?id={$getid}&inv_id={$invid}" method="POST" class="form-horizontal form-column form-bordered form-wizard ui-formwizard" enctype="multipart/form-data" id="formID" novalidate="novalidate">
