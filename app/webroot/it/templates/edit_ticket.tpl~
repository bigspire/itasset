                     ...
                     <div class="span6">
	                   ...
	                   <div class="span6">
									...
									<div class="control-group">
											...
											<div class="controls">
												<textarea name="message" rows="2" class="input-xlarge" placeholder="Message" cols="30" id="message">{if $data.message}{$data.message}{else}{$smarty.post.message}{/if}</textarea> 																					
											</div>
									</div>
				          </div>
							 <div class="span12">
