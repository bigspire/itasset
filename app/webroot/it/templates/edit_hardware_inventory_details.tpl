			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="edit_hardware_inventory_details.php?id={$getid}&inv_id={$invid}">Edit Hardware</a>
						</li>
					</ul>
					...
					<div class="span12">
								...
								<form action="edit_hardware_inventory_details.php?id={$getid}&inv_id={$invid}" method="POST" class="form-horizontal form-column form-bordered form-wizard ui-formwizard" id="formID" novalidate="novalidate">
	...
	<div class="span6">
		...
		<div class="control-group">
			<label for="textfield" class="control-label">Inventory No <span class="red_star"> *</span></label>
				...
				<input name="inventory_no_#index#" class="input-xlarge checkUnique" placeholder="" type="text" id="inventory_no_#index#" value="{$smarty.session['h'][$foo].inventory_no}"/> 
				<div class="errorMsg error" id="inventory_noErr_#index#">{$smarty.session['h'][$foo]['inventory_noErr']} </div>
				</div>
		</div>
		<div class="control-group">
		...
		{html_options class="input-large" placeholder="" style="clear:left" options=$district_{$i} selected=$smarty.session['h'][$foo].district_id}
		{/for} 
		</select>		
