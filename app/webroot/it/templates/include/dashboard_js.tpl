	...
	<script type="text/javascript">
      ...
      function drawChart1(){
        var data = google.visualization.arrayToDataTable([
          ...
          ['{ucfirst($rec.title)} ({$rec.edition})',  {$rec.count}],
		  	{/foreach}
		  	{literal}    
        ]);
      ...
      function drawChart2(){
        var data = google.visualization.arrayToDataTable([
		 ...
		 {/literal}	  		 
          ...
          ['{ucfirst($rec.edition)} ({$rec.no_license})',  {$rec.no_license}],
		  {/foreach}
		  {literal}    
        ]);
      ...
      function drawChart3(){
        var data = google.visualization.arrayToDataTable([
		 ...
		 {/literal}	  		 
          ...
          ['{ucfirst($rec.edition)} ({$rec.no_license})',  {$rec.count}],
		  {/foreach}
		  {literal}    
        ]);
      ...
      function drawChart4(){
        var data = google.visualization.arrayToDataTable([
		 ...
		 {/literal}	  		 
		  ...
		  {assign var=someVar value="_"|explode:$v}
          ['{ucfirst($k)} ({$someVar[0]})',  {$someVar[1]}],
		  {/foreach}
		  {literal}    
        ]);
      ...
      function drawChart6(){
        ...
        {/literal}	  		 
          ...
          ['{ucfirst($rec.title)} ({ucfirst($rec.brand)})',  {$rec.count}],
		  {/foreach}
		  {literal}  
        ]);
