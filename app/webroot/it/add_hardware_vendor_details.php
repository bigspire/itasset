<?php
/* 
Purpose : To add the hardware vendor details.
Created : Gayathri
Modified : Nikitasa
Date : 15-06-2016
*/
...
if($_SESSION['h']['add_hardware_vendor_details'] != 'next'){
...
if(!empty($_POST)){
   ...
   $field = array('contact_number', 'company_email', 'city', 'contact_person', 'address');
	...
	if($_POST['company_name'] == ''){
		...
		$test = 'error';
		$_SESSION['h']['company_name'] = '';
	}else{
		$_SESSION['h']['company_name'] = $_POST['company_name']; 
	...
	if(empty($test)){
		$_SESSION['h']['add_hardware_confirmation'] = 'next';
		if($_POST['next_hdn'] == '1'){
...
$smarty->display('add_hardware_vendor_details.tpl');
?>