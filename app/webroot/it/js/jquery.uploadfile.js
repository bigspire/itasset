...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            uploadButtonClass: "btn btn-sm btn-yellow",
		...
		*/
        ...
        function createProgressDiv(obj, s) {
            ...
            this.abort = $("<div class='btn btn-xs btn-red ajax-file-upload-abort " + obj.formGroup + "'>" + s.abortStr + "</div>").appendTo(this.statusbar)
                .hide();
            this.cancel = $("<div class='btn btn-xs ajax-file-upload-cancel " + obj.formGroup + "'>" + s.cancelStr + "</div>").appendTo(this.statusbar)
                .hide();
            this.done = $("<div class='btn btn-xs btn-success'>" + s.doneStr + "</div>").appendTo(this.statusbar).hide();
