...
if($error){ 
      // query to insert into database. 
		$query = "CALL edit_scrap_hardware('".$_SESSION['scrap_id']."','".$_POST['remarks']."','".$created_date."','".$_SESSION['user_id']."','".$status."')";
		...
		// query to insert into database. 
		$query = "CALL edit_hardware_inventory('".$_SESSION['status_id']."','".$created_date."','".$status."',
