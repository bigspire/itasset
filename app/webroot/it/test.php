...
class libExcel{
	...
	function printCell(){	
		...
		for ($i = 1; $i < 200; $i++) {
			$this->objPHPExcel->getActiveSheet()->setCellValue('A' . $i, $i);
			$this->objPHPExcel->getActiveSheet()->setCellValue('B' . $i, 'Test value');
		}
		// set the header
		$this->setHeader();
	}
	...
	function setHeader(){	
		...
		$this->objPHPExcel->getActiveSheet()->setTitle('Printing');
