...
class HrDesignationController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Designation - HRIS - My PDCA');
	...
	public function create_desig(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Designation - HRIS - My PDCA');				
		if ($this->request->is('post')){ 
			// validates the form
	...
	public function edit_desig($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Designation - HRIS - My PDCA');			
	...
	public function view_desig($id){
		// set the page title		
		$this->set('title_for_layout', 'View Designation - HRIS - My PDCA');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
